# -*- coding: utf-8 -*-
"""
Created on Sat Mar 23 11:45:49 2019
...
class Model: 
	...
	def __init__(self, charList, decoderType=DecoderType.BestPath, mustRestore=False):
		...
		# initialize TF
		(self.sess, self.saver, self.writer) = self.setupTF()
	...
	def setupTF(self):
		...
		if latestSnapshot:
			...
			sess.run(tf.global_vFariables_initializer())
		
		writer = tf.summary.FileWriter(".\model\logs\log", sess.graph)
